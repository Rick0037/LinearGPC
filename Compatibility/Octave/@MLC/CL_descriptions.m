...
set(barb,"facecolor","r")
    ...
    % Ticks
        ...
        % % set(gca,'xminortick',0:5*ceil(MAXSS2_plus1/5));    
...
%% Matrix
    ...
    % Ticks
        ...
        % x
        % % ax.XAxis.MinorTick = 'on';
        % % set(gca,'xminortick') = 0:InputNumber;    
        % set(gca,'xminorgrid','on');
    ...
    for sp=1:InputNumber
      text(sp-0.5,PopSize,['s',num2str(sp)],...
...
set(barb,"facecolor","k")
    ...
    % Ticks
        ...
        % y
        % ax.YAxis.MinorTick = 'on';
        % ax.YAxis.MinorTickValues = 0:5*round(MAXSS1_plus1/5);    
        % set(gca,'yminorgrid','on');
...
%         print(FigName,'-dpng')
 ...
 %% Matrix
    ...
    % Ticks
        ...
        % x
        % % ax.XAxis.MinorTick = 'on';
        % % set(gca,'xminortick') = 0:CstRegNumber;    
        % set(gca,'xminorgrid','on');
    ...
    for sp=1:CstRegNumber
      text(sp-0.5,PopSize,['c',num2str(sp)],...
          'Interpreter','latex','FontSize',1.5*FS,...
          'HorizontalAlignment','center',...
          'VerticalAlignment','top')
    end
